...
class SpringBookSpider(scrapy.Spider):
    name = 'brick_spider'
    base_url = 'http://link.springer.com'
    start_urls = ['http://link.springer.com/openurl?genre=book&isbn=978-0-306-48048-5'
...
,'http://link.springer.com/openurl?genre=book&isbn=978-1-4939-9621-6']
    ...
    def parse(self, response):
        SET_SELECTOR2 = '.cta-button-container__item'
        for element in response.css(SET_SELECTOR2):
            NAME_SELECTOR = 'div a::attr(href)'
            href = element.css(NAME_SELECTOR).extract_first()
            self.save_pdf(response.urljoin(href))
    ...
    def save_pdf(self, url):     
        ...
        if content_Disposition != None:
            ...
            with open(filename, "wb") as Pypdf:
                print("\nStart download of book:", filename)
